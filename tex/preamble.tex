...
\setminted{
  ...
  style=friendly,         % Color scheme
  bgcolor=black!3         % Very light background
}

\setminted[julia]{
  mathescape=true,        % Allow math in comments
}
...
\declaretheorem[name=Problema, style=thmblack, sibling=theorem]{problem}
\declaretheorem[name=Problema, style=thmblack, numbered=no]{problem*}
\declaretheorem[name=Custión, style=thmblack, sibling=theorem]{question}
\declaretheorem[name=Custión, style=thmblack, numbered=no]{question*}
\declaretheorem[name=Ejercicio, style=thmblack, sibling=theorem]{exercise}
